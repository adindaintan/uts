        ...
        <header className="blog-header py-3">
          <div className="row flex-nowrap justify-content-between align-items-center">
            ...
            <div className="col-4 d-flex justify-content-end align-items-center">
              <Link href="/search"><a className="link-secondary" aria-label="Search">
              ...
              <Link href="/login"><a className="btn btn-sm btn-outline-secondary">Sign up</a></Link>
            </div>
          </div>
        </header>
      
        <div className="nav-scroller py-1 mb-2">
          <nav className="nav d-fle x justify-content-between">
            {
              menu.map(
                mn => (<Link href={{
                ...
                <a className="p-2 link-secondary">{mn.title}</a></Link>)
              )
            }
          </nav>
        </div>
